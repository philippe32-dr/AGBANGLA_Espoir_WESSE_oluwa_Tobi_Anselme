...
import 'package:devoir/pages/description.dart';
import 'package:devoir/pages/renseignement.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => DescribeCandidate()),);
        },
        child: Container(
          child: Column(
            children: [
